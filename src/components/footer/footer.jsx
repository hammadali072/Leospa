                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <ul className="flex gap-y-2 flex-col">
                                {menuData.map((item, index) => (
                                    <li key={index}>
                                        <Link to={item.to} className="inline-block uppercase text-black lg:text-lg md:text-base font-medium duration-300 hover:text-primary">{item.text}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                                    ...
                                    <li key={index}>
                                        <Link to={item.path} className='grid grid-cols-[auto_1fr] items-center gap-x-4 group'>
                                            <div className='flex justify-center items-center size-10 bg-primary rounded-full'>
                                                <item.icon className='text-white' size={18} weight='fill' />
                                            </div>
